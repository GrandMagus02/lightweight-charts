...
class Series extends PriceDataSource {
    ...
    _internal_priceAxisViews(pane, priceScale) {
        var _a;
        if (priceScale._internal_id() !== ((_a = this._internal__priceScale) === null || _a === void 0 ? void 0 : _a._internal_id()) && !this._private__isOverlay()) {
            return [];
        }
...
class Pane {
    constructor(timeScale, model, initialPaneIndex = 0) {
        ...
        this._private__stretchFactor = (_b = (_a = options.layout.panes[initialPaneIndex]) === null || _a === void 0 ? void 0 : _a.stretchFactor) !== null && _b !== void 0 ? _b : DEFAULT_STRETCH_FACTOR;
        this._internal_applyScaleOptions(options);
        this._internal_applyOptions(paneOptions);
    }
    _internal_applyOptions(options) {
        var _a, _b;
        this._private__stretchFactor = (_a = options.stretchFactor) !== null && _a !== void 0 ? _a : this._private__stretchFactor;
        this._private__minHeight = (_b = options.minHeight) !== null && _b !== void 0 ? _b : 30;
    }
    ...
    _internal_minHeight() {
        return this._private__minHeight;
    }
...
class ChartModel {
    ...
    _internal_applyOptions(options) {
        merge(this._private__options, options);
        this._private__panes.forEach((p, index) => {
            var _a, _b;
            const paneOptions = (_b = (_a = options.layout) === null || _a === void 0 ? void 0 : _a.panes) === null || _b === void 0 ? void 0 : _b[index];
            if (paneOptions !== undefined) {
                p._internal_applyOptions(paneOptions);
            }
            p._internal_applyScaleOptions(options);
        });
    ...
    _internal_moveSeriesToScale(series, targetScaleId) {
        ...
        if (target === null) {
            ...
            pane._internal_addDataSource(series, targetScaleId, zOrder === null ? undefined : zOrder);
        }
        else {
            // if move to the new scale of the same pane, keep zorder
            // if move to new pane
            const zOrder = (target._internal_pane === pane) ? series._internal_zorder() : undefined;
            target._internal_pane._internal_addDataSource(series, targetScaleId, zOrder === null ? undefined : zOrder);
        }
    }
...
class PaneSeparator {
    constructor(chartWidget, topPaneIndex, bottomPaneIndex, disableResize) {
        ...
        this._private__className = 'lwc-separator-handle';
        this._private__classNameActive = 'lwc-separator-handle--active';
        ...
        if (disableResize) {
            ...
            this._private__handle.classList.add(this._private__className);
    ...
    _internal_getSize() {
        return fancyCanvas.size({
            width: this._private__paneA._internal_getSize().width,
            height: SEPARATOR_HEIGHT,
        });
    }
    _internal_getBitmapSize() {
        return fancyCanvas.size({
            width: this._private__paneA._internal_getBitmapSize().width,
    ...
    _private__mouseDownEvent(event) {
        ...
        const minA = this._private__paneA._internal_state()._internal_minHeight();
        const minB = this._private__paneB._internal_state()._internal_minHeight();
        this._private__minPaneHeight = minA;
        this._private__maxPaneHeight = this._private__totalHeight - minB;
        this._private__pixelStretchFactor = this._private__totalStretch / this._private__totalHeight;
        this._private__mouseActive = true;
        (_a = this._private__handle) === null || _a === void 0 ? void 0 : _a.classList.add(this._private__classNameActive);
    }
    ...
    _private__mouseUpEvent(event) {
        ...
        this._private__pixelStretchFactor = 0;
        this._private__mouseActive = false;
        (_a = this._private__handle) === null || _a === void 0 ? void 0 : _a.classList.remove(this._private__classNameActive);
 ...
 */
function hitTestPaneView(pane, paneViews, x, y) {
    for (const paneView of paneViews) {
        const renderer = paneView._internal_renderer(pane);
...
function hitTestPane(pane, x, y) {
    ...
    for (const source of sources) {
        ...
        const sourceResult = hitTestPaneView(pane, source._internal_paneViews(pane), x, y);
...
class PaneWidget {
    ...
    _private__fireMouseClickDelegate(delegate, event) {
        ...
        if (delegate._internal_hasListeners()) {
            ...
            delegate._internal_fire(this._private__model()._internal_timeScale()._internal_coordinateToIndex(x), { x, y, _internal_paneIndex: paneIndex }, event);
        }
    }
    _private__drawBackground({ context: ctx, bitmapSize }) {
        const { width, height } = bitmapSize;
...
class ChartWidget {
    ...
    _private__adjustSizeImpl() {
        ...
        for (const paneWidget of this._private__paneWidgets) {
            ...
            const minHeight = paneWidget._internal_state()._internal_minHeight();
    ...
    _private__syncGuiWithModel() {
        ...
        for (let i = actualPaneWidgetsCount; i < targetPaneWidgetsCount; i++) {
            ...
            if (i >= 1) {
                const disableResize = !this._private__options.layout.resizePanes;
                const paneSeparator = new PaneSeparator(this, i - 1, i, disableResize);
    ...
    _private__getMouseEventParamsImpl(index, details, event) {
        var _a, _b;
